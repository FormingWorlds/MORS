...
MORS computes the rotational spin-down and high-energy (X-ray, EUV, Ly-$\alpha$) emission history of low-mass stars with masses between $0.1$ and $1.25\,M_\odot$, from 1 Myr through the end of the main sequence. The model is described in full in [Johnstone, Bartel & Güdel (2021)](https://doi.org/10.1051/0004-6361/202038407) and, roughly exists of a rotational model and a high-energy emission model. It also calculates habitable zone fluxes and builds historical spectra from modern reference spectra. 

## Stellar structure

All time-dependent internal stellar properties: radius, luminosity, effective temperature, core and envelope moments of inertia and their rates of change, convective turnover time, core radius and mass, are taken from the pre-computed grids of [Spada et al. (2013)](https://doi.org/10.1088/0004-637X/776/2/87). The grid spans 24 mass bins from $0.1$ to $1.25\,M_\odot$ and is loaded by `stellarevo.StarEvo`. When a stellar mass falls between two grid points, a bilinear interpolation in mass and log-age is performed.
