...
This fetches both the [Spada](https://zenodo.org/records/15729101) and [Baraffe](https://zenodo.org/records/15729114) track sets. The Baraffe tracks are fetched, hash-verified, through fwl-io from their Zenodo record; the Spada grid is fetched from Zenodo with an automatic fallback to [OSF](https://osf.io/9u3fb/) if Zenodo is unavailable. If you only need one set, you can download them individually:
